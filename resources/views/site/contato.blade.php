...
@section('titulo', 'Contato')<!-- SECTION PARA A VARIÁVEL TITLE DA PÁGINA -->

@section('conteudo')

    {{-- @include('site.layouts._partials.topo')  FOI MUDADO PARA O TEMPLATE--}} 
